...
exports.Audio = function (props) {
    ...
    return react_1.useMemo(function () { return react_1.default.createElement("audio", { ref: $media, children: props.children, className: classnames_1.default(props.className) }); }, [$media, props.children, props.className]);
};
